...
const int trigPin = 11; // kết nối chân trig của HFSR-04 với chân 11 arduino
const int echoPin = 12; // kết nối chân echo của HFSR-04 với chân 12 arduino
